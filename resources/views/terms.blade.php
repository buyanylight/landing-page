                    ...
                    <div class="document" style="padding-top: 90px;">
                        ...
                        <div class="document_text_content">
                            ...
                            <ul style="padding-top: 50px;">
                                ...
                                <li>
                                    <span>1.1</span> Please carefully read the Terms and Conditions (“Terms”) for the website located at www.buyanylight.com (the “Website”) including its sub-domains and mobile optimized version, as set out hereinafter. The Website is operated by Almani Lighting LLC (hereinafter referred to also as “Company”) Any ancillary terms, guidelines, the privacy policy (the “Policy”) and other documents made available by the Website from time to time and as incorporated herein by reference, shall be deemed as an integral part of the Terms. These terms set forth the legally binding agreement between you as the user(s) of the Website (hereinafter referred to as “you”, “your” or “User”) and the Company. If you are using the Website or its services on behalf of an entity, organization, or company (collectively &quot;Subscribing Organization&quot;), you declare that you are an authorized representative of that Subscribing Organization with the authority to bind such organization to these Terms; and agree to be bound by these Terms on behalf of such Subscribing Organization. In such a case, &quot;you&quot; in these Terms refers to your Subscribing Organization, and any individual authorized to use the Service on behalf of the Subscribing Organization, including you.
                                </li>

                                <li>
                                    <span>1.2</span> By using company provided services, accessing or using the Website in any manner as laid down herein, including, but not limited to, visiting or browsing it, or contributing content or other materials to it, you agree to be bound by these Terms. </li>

                                <li>
                                    <span>1.3</span> These Terms, and any rights and licenses granted hereunder, may not be transferred or assigned by you, but may be assigned by the Website without restriction. Any attempted transfer or assignment in violation hereof shall be null and void.
                                </li>
                                ...
                                <li>
                                    <span>3.2</span> <span style="font-weight: bold;">Seller Registration.</span> The Seller who can be manufacturers and distributors are required to register on the Website. The registration process requires necessary account information about their company including but not limited to name, the year of establishment, product offerings, location and such other information as may be deemed necessary by the Website.
                                </li>

                                <li>
                                    <span>3.3</span> Sellers are required to select the category of lights that they are willing to sell to the Buyers. It will allow Sellers to receive Request for Quotes (RFQs) for such types of lights.
                                </li>

                                <li>
                                    <span>3.4</span> <span style="font-weight: bold; ">Dashboard or Sellers Backend Office.</span> The Seller accounts have a Dashboard or Sellers Backend Office where they can see all the RFQs for the types of light they can provide. The Sellers can choose to respond for an RFQ and submit the quote along with the visuals of the product to the Buyer through the Private Messaging System of Website.
                                </li>

                                <li>
                                    <span>3.5</span> <span style="font-weight: bold;">Verified Badge. </span> Sellers have an option to upgrade the status of their account to “Verified” by submitting specific documents for evaluation by the Website. After completion of the verification process, the Seller receives the “Verified” badge on the profile.
                                </li>

                                <li>
                                    <span>3.6</span> The Website is free for all Sellers. They can continue to use other existing sales channels such as e-commerce sites and online stores. The Website serves as an additional sales channel that helps the Sellers gain access to niche Buyers for their products.
                                </li>

                                <li>
                                    <span>3.7</span> <span style="font-weight: bold;">Packages.</span> The Sellers can gain a competitive advantage on the Website by purchasing Packages that may give them more exposure to targeted Buyers. These features include priority listing and privileged access to quotes on an RFQ. Once the Buyer has confirmed an order, the Website secures 100% of funds until the Buyer receives the goods.
                                </li>

                                <li>
                                    <span>3.8</span> The Website also handles the logistics for the purposes of delivery of the order. However, the Website shall not be liable if any product is damaged during transition. The claim in this regard may only be filed against the original supplier of the lights or samples.
                                </li>

                                <li>

                                    <span>3.9</span> When an order is confirmed by the Buyer, the Buyer will be charged a 10% Service Fee that will be added in the final quotation along with the shipping fee. These features are applicable on all Packages. Below are our Packages:
                                ...
                                <li><span>7.2</span> Upon verification of details, Website may accept account registration application.</li>

                                <li><span>7.3</span> You represent, warrant and covenant that: (i) you have full power and authority to accept these Terms, to grant any license and authorization and to perform any of your obligations hereunder; (ii) you will undertake the use the Website and Services for personal purposes only; and (iii) the address you provide when registering is your personal address.</li>

                                <ul>
                                    <li><span>7.3.1</span> You must not allow any other person to use your account to access the Website.</li>
                                    <li><span>7.3.2</span> You must notify us in writing immediately if you become aware of any unauthorised use of your account.</li>
                                ...
                                <li><span>8.3</span> You must notify the Website by emailing us at info@buyanylight.com if you have reason to believe that your account is no longer secure for any reason (for example, in the event of a loss, theft or unauthorized disclosure or use of your password).
                                </li>
                                ...
                                <ul>
                                    ...
                                    <li><span>i.</span> not to access the Website or services using a third-party&#39;s account/registration without the express consent of the account holder;
                                    </li>
                                    <li>
                                        <span>ii.</span> not to use the Website for illegal purposes;
                                    </li>
                                    <li>
                                        <span>iii.</span> not to commit any acts of infringement on the Website or with respect to content on the Website;
                                    </li>
                                    <li>
                                        <span>iv.</span> not to copy any content for republication in print or online;
                                    </li>
                                    <li>
                                        <span>v.</span> not to create reviews or blog entries for or with any purpose or intent that does not in good faith comport with the purpose or spirit of the Website;
                                    </li>
                                    <li><span>vi.</span> not to attempt to gain unauthorized access to other computer systems from or through the Website;</li>
                                    <li>
                                        <span>vii.</span> not to interfere with another person&#39;s use and enjoyment of the Website or another entity&#39;s use and enjoyment of the Website;
                                    </li>
                                    <li><span>viii.</span> not to upload or transmit viruses or other harmful, disruptive or destructive files; and/or</li>
                                    <li><span>ix.</span> not to disrupt, interfere with, or otherwise harm or violate the security of the Website, or any services, system restores, accounts, passwords, servers or networks connected to or accessible through the Website or affiliated or linked website.
                                    </li>
                                    <li>
                                        <span> x.</span> not to use the Website in any way or take any action that causes, or may cause, damage to the Website or impairment of the performance, availability or accessibility of the Website;
                                    </li>
                                    <li><span>xi.</span> not to use the Website in any way that is unlawful, illegal, fraudulent or harmful, or in connection with any unlawful, illegal, fraudulent or harmful purpose or activity;</li>
                                    <li>
                                        <span>xii.</span> not to use se the Website to copy, store, host, transmit, send, use, publish or distribute any material which consists of (or is linked to) any spyware, computer virus, Trojan horse, worm, keystroke logger, rootkit or other malicious computer software;
                                    </li>

                                    <li>
                                        <span>xiii.</span> not to conduct any systematic or automated data collection activities (including without limitation scraping, data mining, data extraction and data harvesting) on or in relation to the Website without the express written consent of the Website owner;
                                    </li>

                                    <li><span>xiv.</span> not to access or otherwise interact with the Website using any robot, spider or other automated means;</li>

                                    <li><span>xv.</span> not to violate the directives set out in the robots.txt file for the website;</li>
                                    <li><span>xvi.</span> not to use data collected from the website for any direct marketing activity (including without limitation email marketing, SMS marketing, telemarketing and direct mailing);</li>
                                    <li><span>xvii.</span> not to infringe these Terms or allow, encourage or facilitate others to do the same;</li>
                                    <li><span>xviii.</span> not to plagiarize and/or infringe the intellectual property rights or privacy rights of any third party;</li>
                                    <li><span>xix.</span> not to disturb the normal flow of Services provided within the Website;</li>
                                    <li><span>xx.</span> not to create a link from the Website to another website or document without Company’s prior written consent;</li>
                                    <li><span>xxi.</span> not to obscure or edit any copyright, trademark or other proprietary rights notice or mark appearing on the Website;</li>
                                    <li><span>xxii.</span> not to create copies or derivate works of the Website or any part thereof;</li>
                                    <li><span>xxiii.</span> not to reverse engineer, decompile or extract the Website’s source code;</li>
                                    <li><span>xxiv.</span> not to remit or otherwise make or cause to deliver unsolicited advertising, email spam or other chain letters;</li>
                                    <li><span>xxv.</span> not to collect, receive, transfer or disseminate any personally identifiable information of any person without consent from title holder; and/or</li>
                                    <li><span>xxvi.</span> not to pretend to be or misrepresent any affiliation with any legal entity or third party.</li>

                                </ul>

                                <li><span>12.3</span> In addition to the above clause, unless specifically endorsed or approved by the Website, the following uses and activities of and with respect to the Website and the Website Services are prohibited:
                                </li>

                                <ul>
                                    <li><span>i.</span> criminal or tortuous activity, including child pornography, fraud, trafficking in obscene material, drug dealing, gambling, harassment, stalking, spamming, copyright infringement, patent infringement, or theft of trade secrets;</li>

                                    <li><span>ii.</span> transmitting chain letters or junk email;</li>
                                    <li><span>iii.</span> engaging in any automated use of the Website or the Website Services.</li>
                                    <li><span>iv.</span> interfering with, disrupting, or creating an undue burden on the Website or the Website Services or the networks or services connected or linked thereto;</li>
                                    <li><span>v.</span> attempting to impersonate another user or person;</li>
                                    <li><span>vi.</span>using the username of another user;</li>
                                    <li><span>vii.</span> selling or otherwise transferring your profile;</li>
                                    <li><span>viii.</span> using any information obtained from the Website or the Website Services in order to harass, abuse, or harm another person;</li>
                                    <li><span>ix.</span> deciphering, decompiling, disassembling or reverse engineering any of the software comprising or in any way making up a part of the Website or the Website Services;</li>
                                    <li><span>x.</span> attempting to bypass any measures of the Website or the Website Services designed to prevent or restrict access to the Website or the Website Services, or any portion of the Website or the Website Services;</li>
                                    <li><span>xi.</span> harassing, annoying, intimidating or threatening any the Website employees or agents engaged in providing any portion of the Website Services;</li>
                                    <li><span>xii.</span> using the Website and/or the Website Services in any manner inconsistent with any and all applicable laws and regulations.</li>
                                    <li><span>xiii.</span> Using data collected from the website to contact individuals, companies or other persons or entities.</li>
                                    <li><span>xiv.</span> Supplying false, untrue, expired, incomplete or misleading information through the Website.</li>
                                ...
                                <li>
                                    <span>20.2</span> You indemnify the Website and its management for any time that the Website may be unavailable due to routine maintenance, updates or any other technical or non-technical reasons. You agree to indemnify the Website and its management for any error, omission, interruption, deletion, defect, delay in operation or transmission, communication line failure, theft or destruction or unauthorized access to your published content, damages from lost profits, lost data or business interruption.
                                </li>
                                ...
                                <li><span>21.3</span> Content Moderation. Company hereby reserves the right, at its sole and final discretion, to review any and all content delivered into the Website, and use moderators and/or any monitoring technology to flag and remove any user generated content or other content deemed inappropriate.</li>

                                <li>
                                    <span>21.4</span> Force Majeure. Company is no liable for any failure of performance on its obligations as set forth herein, where such failure arises from any cause beyond Company&#39;s reasonable control, including but not limiting to, electronic, power, mechanic or Internet failure, from acts of nature, forces or causes beyond our control, including without limitation, Internet failures, computer, telecommunications or any other equipment failures, electrical power failures, strikes, labor disputes, riots, insurrections, civil disturbances, shortages of labor or materials, fires, flood, storms, explosions, acts of God, war, governmental actions, orders of domestic or foreign courts or tribunals or non-performance of third parties.
                                </li>

                                <li><span>21.5</span> Headings. The titles of paragraphs in these Terms are shown only for ease of reference and will not affect any interpretation therefrom.</li>
                                <li><span>21.6</span> No Waiver. Failure by Company to enforce any rights hereunder shall not be construed as a waiver of any rights with respect to the subject matter hereof.</li>
                                <li><span>21.7</span> No Relationship. You and Company are independent contractors, and no agency, partnership, joint venture, employee-employer, or franchiser-franchisee relationship is intended or created by these Terms.</li>
