		...
		<div class="container-fluid">
			...
			<ul>
				<li>
								...
								<ul>
									<li>
										<span><b>2.1</b></span> Each time by viewing, using, accessing, browsing, or submitting any content or material on the Website, including the webpages contained or hyperlinked therein and owned or controlled by the Website and its services, whether through the Website itself or through such other media or media channels, devices, software, or technologies as the Website may choose from time to time, you are agreeing to abide by these Terms, as amended from time to time with or without your notice.
									</li>
									<li class="pt-2">
										<span><b>2.2</b></span> The Website reserves the right to modify or discontinue, temporarily or permanently, and at any time, the Website and/or the Website Services (or any part thereof) with or without notice. You agree that the Website shall not be liable to you or to any third party for any modification, suspension or discontinuance of the Website Services.
									</li>

									<li class="pt-2">
										<span><b>2.3</b></span> Website or the Website management may modify these Terms from time to time, and any change to these Terms will be reflected on the Website with the updated version of the Terms and you agree to be bound to any changes to these Terms when you use the Website or the Website Services. The Website may also, in its sole and absolute discretion, choose to alert via email all users with whom it maintains email information of such modifications.
									</li>

									<li class="pt-2">
										<span><b>2.4</b></span> Also, occasionally there may be information on the Website or within the Website Services that contains typographical errors, inaccuracies or omissions that may relate to service descriptions, pricing, availability, and various other information, and the Website management reserves the right to correct any errors, inaccuracies or omissions and to change or update the information at any time, without prior notice.
									</li>

									<li class="pt-2">
										<span><b>2.5</b></span> When you register an account on the Website and/or upload, submit, enter any information or material to the Website or use any of the Website Services, you shall be deemed to have agreed to and understand the Terms.
									</li>

									<li style="text-transform: uppercase;" class="pt-2">
								...
								<h3 style="padding-top:25px;">3. Terms of Service </h3>
									...
									<ul>
								<li class="pt-2">
									<span><b>3.1</b></span> The Website provides a platform which connects Sellers and Buyers of different types and brands of lights. The Website is an innovative lighting sourcing platform which connects Seller and Buyers directly together without the need of an intermediary. Sellers can be manufacturers as well as distributors while Buyers can be retailers, contractors, or the end users who need to source substantial number of lights. The Website allows Buyers to submit Request for Quotes (RFQs) to Sellers. In response, the Sellers will be able to send their Quotes to these Buyers and lock the deal (“Services”).
								</li>

								<li class="pt-2">
									<span><b>3.2</b></span> <span style="font-weight: bold;">Seller Registration.</span> The Seller who can be manufacturers and distributors are required to register on the Website. The registration process requires necessary account information about their company including but not limited to name, the year of establishment, product offerings, location and such other information as may be deemed necessary by the Website.
								</li>

								<li class="pt-2">
									<span><b>3.3</b></span> Sellers are required to select the category of lights that they are willing to sell to the Buyers. It will allow Sellers to receive Request for Quotes (RFQs) for such types of lights.
								</li>

								<li class="pt-2">
									<span><b>3.4</b></span> <span style="font-weight: bold; ">Dashboard or Sellers Backend Office.</span> The Seller accounts have a Dashboard or Sellers Backend Office where they can see all the RFQs for the types of light they can provide. The Sellers can choose to respond for an RFQ and submit the quote along with the visuals of the product to the Buyer through the Private Messaging System of Website.
								</li>

								<li class="pt-2">
									<span><b>3.5</b></span> <span style="font-weight: bold;">Verified Badge. </span> Sellers have an option to upgrade the status of their account to “Verified” by submitting specific documents for evaluation by the Website. After completion of the verification process, the Seller receives the “Verified” badge on the profile.
								</li>

								<li class="pt-2">
									<span><b>3.6</b></span> The Website is free for all Sellers. They can continue to use other existing sales channels such as e-commerce sites and online stores. The Website serves as an additional sales channel that helps the Sellers gain access to niche Buyers for their products.
								</li>

								<li class="pt-2">
									<span><b>3.7</b></span> <span style="font-weight: bold;">Packages.</span> The Sellers can gain a competitive advantage on the Website by purchasing Packages that may give them more exposure to targeted Buyers. These features include priority listing and privileged access to quotes on an RFQ. Once the Buyer has confirmed an order, the Website secures 100% of funds until the Buyer receives the goods.
								</li>

								<li class="pt-2">
									<span><b>3.8</b></span> The Website also handles the logistics for the purposes of delivery of the order. However, the Website shall not be liable if any product is damaged during transition. The claim in this regard may only be filed against the original supplier of the lights or samples.
								</li>

								<li class="pt-2">

									<span><b>3.9</b></span> When an order is confirmed by the Buyer, the Buyer will be charged a 10% Service Fee that will be added in the final quotation along with the shipping fee. These features are applicable on all Packages. Below are our Packages:
								...
								<ul>
									...
									<li class="pt-2">
										<span><b>3.9.1</b></span> <b>BASIC</b> – Free Access: A free user can register on the Website without any upfront payment. The basic account presents an excellent way to access the various functions of Website before deciding on the appropriate Package to subscribe. This Package may be useful for those who want to make a quick inquiry to receive fast and easy quotes. The free user must choose any of the Enterprise subscriptions (Delphine, Shark, Whale) to request for samples or confirm an order.
									</li>

									<li class="pt-2">
										<span><b>3.9.2</b></span> <b>ESSENTIAL</b> – Private Homes, Villas, Castles and more: This Package is designed for those users who want to procure lights for their private places like homes, villas and castles etc. Users may select this project and start a project. They shall be required to upload their lighting requirements such as description, photos of their all areas, and/or their current lighting etc. Our team will handle the technical part and design lighting and provide them with a quote for their project.
									</li>

									<li class="pt-2">
										<span><b>3.9.3</b></span> <b>CORPORATE</b> – Consultants, Contractors, Project Owners: The corporate users such as contractors, consultants and project owners may choose the Corporate Package. After starting a project, the user selects from our Gold, Diamond or Platinum Package (based on the size of the project). Then the user us required to upload the requirements. It shall not be required to make an upfront payment to receive a solution and a quote from the Website. Once requirements have been submitted to our satisfaction, our team will prepare a customized quote and share it with the user. An excellent feature -exclusive to our Corporate users- is the customisation of quotes. They can easily add markupsmark-ups to the quotes we give transparently.
									</li>

									<li class="pt-2">
										<span><b>3.9.4</b></span> <b>ENTERPRISE</b> – Business to Business &amp; Business to Consumer: The enterprise users are businesses such as lighting companies, a consultant or a homeowner that prefers to source for lights personally, and directly from manufacturers. Enterprise users will be able to access the Website’s innovative platform where they can upload their requirements and get the best possible quotes directly from the various world-class manufacturers affiliated with us. Once the enterprise user uploads the requirements, our intelligent systems match manufacturers that have products that align with the request submitted and sends out an RFQ (Request for Quotation) automatically. After selecting the preferred supplier, the Enterprise user may confirm the order immediately or request a sample with the Shark or Whale Package. Enterprise users can choose between the Dolphin, Shark, and Whale monthly subscriptions, based on the volume of their sourcing needs.

									</li>

								</ul>

								<li class="pt-2"><span><b>3.10</b></span> Sellers who register their accounts with the Website undertake and agree that they shall not impose any direct or indirect limit or restriction on the minimum quantity of an order. In other words, they shall be bound to deliver every order to the Buyer or the Company without taking into consideration the size of the order. </li>

								<li class="pt-2"><span><b>3.11</b></span> Company reserves the right to issue all receipts/invoices in its own name for maintaining the privacy of Sellers and in order to restrict Buyers and Sellers from communicating and/or transacting outside BAL's platform. </li>
								...
								<li class="pt-2">
									<span><b>5.1</b></span> The Seller shall be directly responsible for the terms and conditions pertaining to refund/replace or claim of warranty of a product. The Seller agrees that the Website shall not be held responsible if there is a complaint lodged by the Buyer.
								</li>
								...
								<li class="pt-2">
									<span><b>6.1</b></span> The Website shall use commercially reasonable efforts to keep it up and running 24 hours a day, seven days a week; provided, however, that it may carry out scheduled and unscheduled maintenance work as necessary from time to time and such maintenance work may impact the availability of the Website.
								</li>
								...
								<li class="pt-2"><span><b>7.1</b></span> In order to use some or all of the functionalities and Services provided through the Website, you may be required to register an account with the Website as mentioned above. At the time of registration of account, you will be asked to complete a registration form which shall require you to provide personal information such as name, address, phone number, email address, username and other personal information.
								</li>

								<li class="pt-2"><span><b>7.2</b></span> Upon verification of details, Website may accept account registration application.</li>

								<li class="pt-2"><span><b>7.3</b></span> You represent, warrant and covenant that: (i) you have full power and authority to accept these Terms, to grant any license and authorization and to perform any of your obligations hereunder; (ii) you will undertake the use the Website and Services for personal purposes only; and (iii) the address you provide when registering is your personal address.</li>

								<ul>
									<li class="pt-2"><span><b>7.3.1</b></span> You must not allow any other person to use your account to access the Website.</li>
									<li class="pt-2"><span><b>7.3.2</b></span> You must notify us in writing immediately if you become aware of any unauthorised use of your account.</li>
									<li class="pt-2"><span><b>7.3.3</b></span> You must not use any other person&#39;s account to access the Website, unless you have that person&#39;s express written permission to do so.</li>
								...
								<h3 style="padding-top:25px;">8. User IDs and passwords</h3>
									...
									<ul>
								<li class="pt-2"><span><b>8.1</b></span> If you register for an account with the Website, you will be asked to choose a user ID and password. Your user ID must not be misleading and must comply with the content rules set out in this document; you must not use your account or user ID for or in connection with the impersonation of any person.</li>

								<li class="pt-2"><span><b>8.2</b></span> You shall be responsible to maintain the confidentiality of your password and shall be responsible for all uses via your registration and/or login, whether authorized or unauthorized by you. You agree to immediately notify us of any unauthorized use or your registration, user account or password.</li>

								<li class="pt-2"><span><b>8.3</b></span> You must notify the Website by emailing us at info@buyanylight.com if you have reason to believe that your account is no longer secure for any reason (for example, in the event of a loss, theft or unauthorized disclosure or use of your password).
								</li>

								<li class="pt-2">
									<span><b>8.4</b></span> You are responsible for any activity and content on the account arising out of any failure to keep your password confidential, and may be held liable for any losses arising out of such a failure.
								</li>

								<li class="pt-2"><span><b>8.5</b></span> Registration data and other personally identifiable information that we may collect is subject to the terms of our Privacy Policy.</li>		
									</ul>
								</ul>
								...
								<h3 style="padding-top:25px;">9. Termination of Account and Discontinuation of Use</h3>
									...
									<ul>
								<li class="pt-2"><span><b>9.1</b></span> If you engage in Prohibited Conduct or otherwise violate any of the Terms, your permission to use the Website will be terminated.</li>

								<li class="pt-2"><span><b>9.2</b></span> You also agree that we may, at any time and without notice to you, suspend or revoke your access to and use of the Website, and any accounts you may have in connection with the Service including: (i) where we determine in our sole discretion that such action is reasonable in order to comply with legal requirements or to protect the rights or interests of Company or any third party; or (ii) in connection with any general discontinuation of the Website services.</li>

								<li class="pt-2"><span><b>9.3</b></span> We will have no liability whatsoever on account of any change to the Service or any suspension or revocation of your access to or use of the Website. You may terminate your account at any time by sending us an email to info@buyanylight.com.</li>
								...
								<h3 style="padding-top:25px;">10. Electronic Signature Consent</h3>
									...
									<ul>
								<li><span><b>10.1</b></span> You agree that your “Electronic Signature” is the legal equivalent of your manual signature for this Agreement, thereby indicating your consent to do business electronically.</li>

								<li class="pt-2"><span><b>10.2</b></span> By clicking on the applicable button in the Website, you will be deemed to have executed these Terms electronically via your Electronic Signature with Company; effective on the date you first click to accept these Terms.</li>
								...
								<h3 style="padding-top:25px;">12. User Responsibility</h3>
									...
									<ul>
								<li class="pt-2"><span><b>12.1</b></span> Users are solely responsible for all of the transactions conducted on, through or as a result of use of the Website or Services.</li>

								<li class="pt-2"><span><b>12.2</b> </span>You agree that the use of the Website and/or the Website Services on the Website is subject to all applicable local, state and federal laws and regulations. You also agree:</li>
								...
								<li class="pt-2"><span><b>12.3</b></span> In addition to the above clause, unless specifically endorsed or approved by the Website, the following uses and activities of and with respect to the Website and the Website Services are prohibited:
								</li>
								...
								<li class="pt-2"><span><b>12.4</b></span> You also acknowledge and accept that any violation of the aforementioned provisions may result in the immediate termination of your access to the Website and use of our Services, without refund, reimbursement, or any other credit on our part. Access to the Website may be terminated or suspended without prior notice or liability of Company. You represent and warrant to us that you have all right, title, and interest to any and all content you may post, upload or otherwise disseminate through the Website. You hereby agree to provide Company with all necessary information, materials and approval, and render all reasonable assistance and cooperation necessary for our Services.</li>
								...
								<h3 style="padding-top:25px;">14. Third party rights</h3>
									...
									<ul>
								<li class="pt-2"><span><b>14.1</b></span> A contract under the Terms is for our benefit and your benefit, and is not intended to benefit or be enforceable by any third party.</li>
								<li class="pt-2"><span><b>14.2</b></span> The exercise of the parties&#39; rights under a contract under the Terms is not subject to the consent of any third party.</li>
								<li class="pt-2"><span><b>14.3</b></span> You agree not to; modify, copy, distribute, transmit, display, perform, reproduce, publish, license, create derivative works from, transfer, scrape, gather, market, rent, lease, re-license, reverse engineer, or sell any information published by other users without the original publishers written consent.</li>
								...
								<h3 style="padding-top:25px;">16. Term and Termination</h3>
									...
									<ul>
								<li class="pt-2"><span><b>16.1</b></span> The term hereof shall begin on the date that comes first among: (i) first access to the Website; (ii)your first access or execution of our Services; or (iii) Company begins providing its Services to you.</li>
								<li class="pt-2"><span><b>16.2</b></span> The term hereof will automatically end on the earlier date of either your: (i) account deactivation, suspension, freezing or deletion; (ii) access termination or access revocation for our Services or the Website; (iii) Company’s termination of these Terms or its Services, at its sole and final discretion; (iv) the termination date indicated by Company to you from time to time; or (v) Company’ decision to make the Website or Services no longer available for use, at its sole and final discretion.</li>

								<li class="pt-2"><span><b>16.3</b></span> Upon expiration of these Terms or termination of your subscription to our Services, you shall thereafter immediately cease any and all use of our Services, along with any and all information and data collected therefrom.</li>
