...
<section class="section-1 mt-5 pt-5">
	<div class="container h-100 d-flex align-items-center">
		<div class="text-white" style="margin-left: 70px; margin-bottom: auto; margin-top: 25px; position: relative;">
			<h1>
				<b>
					Sourcing Reinvented
				</b>
			...
			<img border="0" 
			style="height: 100px; position: absolute; bottom: 0px; right: -75px;" 
