    ...
    <section>
        <div class="container">
            <div class="document pt-5">
                ...
                <h3 class="pt-3">Information We Collect &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                <ul>
                    <li class="pt-2">
                ...
                <h3 class="pt-3">Name and Address of the Data Controller &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                <ul>
                    <li class="pt-2">
                        ...
                        <ul>
                            ...
                            <li class="pt-2">
                                <span style="font-weight: bold">Address:</span> Almani Lighting L.L.C Dubai Investment Park 1, Opp. Green Community East, Showroom 10, P.O. BOX 3219, Dubai, United Arab Emirates
                            </li>
                            <li class="pt-2">
                ...
                <h3 class="pt-3">Consent and its Withdrawal &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                <ul>
                    <li class="pt-2">
                    ...
                    <li class="pt-2">
                        If you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at any time, by contacting us at <a href="mailto:info@buyanylight.com">info@buyanylight.com</a>.
                    </li>
                </ul>

                <h3 class="pt-3">Promotional Email &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                <ul>
                    <li class="pt-2">
                        You agree that the Website and/or third parties may from time to time send e-mail messages to you which offer products and services, contain advertisements, promotions, subscriptions or registration-based services or other material. If you wish to discontinue receiving such email, you may opt-out by writing us through email at <a href="mailto:info@buyanylight.com">info@buyanylight.com</a>. Your preferences will then be updated.
                    </li>
                </ul>

                <h3 class="pt-3"> How We Use and Process the Data &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                <ul>
                    <li class="pt-2">
                ...
                <h3 class="pt-3"> Disclosure of Data &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                <ul>
                    <li class="pt-2">
                ...
                <h3 class="pt-3"> Data Storage &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                <ul>
                    <li class="pt-2">
                ...
                <h3 class="pt-3">  How We Protect Your Information &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                <ul>
                    <li class="pt-2">
                ...
                <h3 class="pt-3">  The rights of Users &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                <ul>
                    <li class="pt-2">
                       You may exercise certain rights regarding your Data processed by us. In particular, you have the right to do the following:
                       <ul>
                           <li class="pt-2">
                                <b>Right of confirmation</b> <br>
                           ...
                           <li class="pt-2">
                            ...
                            <li class="pt-2">
                                ...
                                <div class="pt-2">
                                    If you wish to avail yourself this right of access, you may, at any time, contact us at <a href="mailto:info@buyanylight.com">info@buyanylight.com</a>.
                                </div>
                            </li>
                            <li class="pt-2">
                                <b>Right to erasure (Right to be forgotten)</b> <br>
                                    ...
                                    <ul>
                                        <li class="pt-2">The personal data are no longer necessary in relation to the purposes for which they were collected or otherwise processed.</li>
                                        <li class="pt-2"> You withdraw consent to which the processing is based according to point (a) of Article 6(1) of the GDPR, or point (a) of Article 9(2) of the GDPR, and where there is no other legal ground for the processing.</li>
                                        <li class="pt-2"> You object to the processing pursuant to Article 21(1) of the GDPR and there are no overriding legitimate grounds for the processing, or you object to the processing pursuant to Article 21(2) of the GDPR.</li>
                                        <li class="pt-2"> The personal data have been unlawfully processed.</li>
                                        <li class="pt-2"> The personal data must be erased for compliance with a legal obligation in Union or Member State law to which the Company is subject.
                                        </li>
                                        <li class="pt-2"> The personal data have been collected in relation to the offer of information society services referred to in Article 8(1) of the GDPR.</li>
                                    </ul>
                                    <div class="pt-2">
                                        If one of the aforementioned reasons applies, and you wish to request the erasure of personal data stored by the Company, you may, at any time, contact us at <a href="mailto:info@buyanylight.com">info@buyanylight.com</a>.
                                    </div>
                                    <div class="pt-2">
                                ...
                                <li class="pt-2">
                                    <b>Right of restriction of processing</b><br>
                                ...
                                <li>
                                    <b>Automated individual decision-making, including profiling</b><br>
                                ...
                                <li class="pt-2">
                                    <b> Right to withdraw data protection consent</b><br>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            If you wish to exercise the right to withdraw the consent, you may, at any time, contact us. You may initiate request with us at <a href="mailto:info@buyanylight.com">info@buyanylight.com</a> to exercise any of the above mentioned rights. We shall review your request and, in our own discretion, honor your request, if deemed necessary by us, within reasonable time.
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <h3 class="pt-3">  Compliance with the GDPR &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                    <ul>
                        <li class="pt-2">
                    ...
                    <h3 class="pt-3">  Cookies &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                    <ul>
                        <li class="pt-2">
                    ...
                    <h3 class="pt-3"> Third Party Links &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                    <ul>
                        <li class="pt-2">
                    ...
                    <h3 class="pt-3"> Changes to this Privacy Statement &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                    <ul>
                        <li class="pt-2">
                    ...
                    <h3 class="pt-3"> Contact Us &nbsp;<i class="fa fa-caret-down caret_down hide_group"></i><i class="fa fa-caret-right caret_right"></i></h3>
                    <ul>
                        <li class="pt-2">
                             If you have questions about our Privacy Policy, please contact us via email: <a href="mailto:info@buyanylight.com"> info@buyanylight.com</a>
                        </li>
                    </ul>
                </div>
            </div>
